...
restores while clean exits stay byte-transparent, and preserves output and exit
status; non-interactive and unsupported-platform runs fall back to direct
execution.
