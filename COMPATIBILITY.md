...
| Web fetch | partial | Permission-gated public HTTP(S) fetches enforce DNS/dial/redirect SSRF checks, bounded bodies, structured HTML-to-Markdown conversion, relative links, executable/embed stripping and binary rejection; caching, overflow artifacts and media downloads remain |
