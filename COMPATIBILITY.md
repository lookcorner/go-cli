...
| ACP | partial | Protocol v1 JSON-RPC stdio supports independent sessions, prompt continuation, streamed text/tool lifecycle updates, cancellation, close, client-provided stdio MCP servers and tool-correlated permission requests; load/list/resume, modes, rich prompt content and ACP client mode remain |
