...
| Skills / AGENTS.md | partial | Compatible home-level and Git-root-to-CWD scoped instruction/rules and skill discovery, deeper-scope precedence, `GROK_HOME`, source-labelled injection, Git-native instruction ignore filtering and lazy `skill` loading work; vendor compatibility gates and conditional skills remain |
