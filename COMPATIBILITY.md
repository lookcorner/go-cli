...
| MCP | partial | Stdio and Streamable HTTP lifecycle, session/protocol headers, JSON/SSE responses, version negotiation, paginated tool discovery/calls and shutdown work; standalone SSE transport, resources, prompts, sampling and list-change reload remain |
