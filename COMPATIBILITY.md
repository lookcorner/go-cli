...
| Skills / AGENTS.md | partial | Compatible root instruction/rules discovery, source-labelled injection, user/workspace skill discovery, Git-native nested/global ignore filtering and lazy `skill` loading work; scoped nested instruction loading and conditional skills remain |
