...
| ACP | partial | Protocol v1 JSON-RPC stdio supports independent sessions, prompt continuation, streamed text/tool lifecycle updates, cancellation, close, client-provided stdio MCP servers, embedded text context and tool-correlated permission requests; load/list/resume, modes, image/audio prompts and ACP client mode remain |
