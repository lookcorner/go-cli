...
| Git / worktrees / hunk tracking | partial | Git tracked/staged/untracked hunk parsing, stable IDs, file summaries, file-tool agent attribution, ACP read queries, and safe hunk/file/all accept/reject actions work; mixed-source per-hunk attribution, prompt-index turn actions, linked/standalone worktree lifecycle and persistence remain |
