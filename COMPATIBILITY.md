...
| Skills / AGENTS.md | partial | Compatible Git-root-to-CWD scoped instruction/rules discovery, deeper-rule precedence, source-labelled injection, user/workspace skill discovery, Git-native nested/global ignore filtering and lazy `skill` loading work; home-level instruction compatibility gates and conditional skills remain |
