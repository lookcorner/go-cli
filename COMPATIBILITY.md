...
and tmux-wrapped OSC 52 writes into the native clipboard, and preserves output
and exit status; non-interactive and unsupported-platform runs fall back to
direct execution.
