...
| ACP | partial | Protocol v1 JSON-RPC stdio supports independent session creation, prompt continuation, streamed text updates, cancellation, close and bidirectional permission requests; client-provided MCP servers, tool-call updates, load/list/resume, modes and ACP client mode remain |
