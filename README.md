...
flowcharts, graphs, state, sequence, class, entity-relationship, info, pie, timeline, journey,
Gantt, packet, block, Kanban, Git graph, Sankey, quadrant, radar, XY chart, and mindmap diagrams are rendered as width-bounded
Unicode relationship, version, percentage, chronology, task, bit-range, commit-history,
flow, grid, board, coordinate, axis/value, series, or hierarchy art.
