...
cancelled during session cleanup. ACP exposes `x.ai/task/list`,
`x.ai/task/kill`, and the typed `x.ai/subagent/get`, `list_running`, and
`cancel` methods. Worktree isolation, an alternate child cwd,
