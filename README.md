...
`/preview-image`, click-to-open on Kitty placeholders, and `/play-video <path>`
(ffmpeg frame extract) bordered popup chrome are ready; prompt-chip hover
preview remains. Image
