...
`NO_COLOR`, Apple Terminal truecolor/OSC 52 limits, iTerm2 OSC 52 permission and VS Code-family SSH non-ASCII copy caveats, SSH unknown-brand OSC 52 delivery-unverified gaps, VTE/xterm.js Shift+Enter newline-fallback gaps, default notification BEL-fallback and focus-tracking gaps, and Byobu-on-screen — without calling the model.
