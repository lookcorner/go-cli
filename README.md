...
Gantt, packet, Git graph, and Sankey diagrams are rendered as width-bounded Unicode
relationship, percentage, chronology, task, bit-range, commit-history, or flow art.
