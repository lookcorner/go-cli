...
On directly supported terminals, Markdown links and quoted absolute file paths use
safe OSC 8 targets; spaces in file paths are preserved and percent-encoded.
