...
func TestStaticExtensionsAndCompactCommand(t *testing.T) {
	...
	if len(commands) != 8 || commands[0].(map[string]any)["name"] != "compact" || commands[0].(map[string]any)["input"].(map[string]any)["hint"] != "optional context about what to preserve" || commands[1].(map[string]any)["name"] != "always-approve" || commands[2].(map[string]any)["name"] != "privacy" || commands[3].(map[string]any)["name"] != "terminal-setup" || commands[4].(map[string]any)["name"] != "usage" || commands[5].(map[string]any)["name"] != "release-notes" || commands[6].(map[string]any)["name"] != "context" || commands[7].(map[string]any)["name"] != "session-info" {
