...
func TestStaticExtensionsAndCompactCommand(t *testing.T) {
	...
	if len(commands) != 7 || commands[0].(map[string]any)["name"] != "compact" || commands[0].(map[string]any)["input"].(map[string]any)["hint"] != "optional context about what to preserve" || commands[1].(map[string]any)["name"] != "always-approve" || commands[2].(map[string]any)["name"] != "privacy" || commands[3].(map[string]any)["name"] != "terminal-setup" || commands[4].(map[string]any)["name"] != "usage" || commands[5].(map[string]any)["name"] != "context" || commands[6].(map[string]any)["name"] != "session-info" {
...
func TestMemoryFlushExtensionAndSlashCommand(t *testing.T) {
	...
	if len(commands) != 12 || commands[2].(map[string]any)["name"] != "privacy" || commands[3].(map[string]any)["name"] != "terminal-setup" || commands[4].(map[string]any)["name"] != "usage" || commands[5].(map[string]any)["name"] != "flush" || commands[6].(map[string]any)["name"] != "dream" || commands[7].(map[string]any)["name"] != "memory" || commands[8].(map[string]any)["name"] != "context" || commands[9].(map[string]any)["name"] != "session-info" || commands[10].(map[string]any)["name"] != "goal" || commands[11].(map[string]any)["name"] != "loop" {
	...
	commands = commandResponse["result"].(map[string]any)["commands"].([]any)
	if len(commands) != 10 || commands[2].(map[string]any)["name"] != "privacy" || commands[3].(map[string]any)["name"] != "terminal-setup" || commands[4].(map[string]any)["name"] != "usage" || commands[5].(map[string]any)["name"] != "memory" || commands[6].(map[string]any)["name"] != "context" || commands[7].(map[string]any)["name"] != "session-info" || commands[8].(map[string]any)["name"] != "goal" || commands[9].(map[string]any)["name"] != "loop" {
