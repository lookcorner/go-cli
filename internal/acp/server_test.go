...
func TestStaticExtensionsAndCompactCommand(t *testing.T) {
	...
	if len(commands) != 8 || commands[0].(map[string]any)["name"] != "compact" || commands[0].(map[string]any)["input"].(map[string]any)["hint"] != "optional context about what to preserve" || commands[1].(map[string]any)["name"] != "always-approve" || commands[2].(map[string]any)["name"] != "privacy" || commands[3].(map[string]any)["name"] != "doctor" || commands[4].(map[string]any)["name"] != "usage" || commands[5].(map[string]any)["name"] != "release-notes" || commands[6].(map[string]any)["name"] != "context" || commands[7].(map[string]any)["name"] != "session-info" {
...
func TestMemoryFlushExtensionAndSlashCommand(t *testing.T) {
	...
	if len(commands) != 16 || commands[2].(map[string]any)["name"] != "privacy" || commands[3].(map[string]any)["name"] != "doctor" || commands[4].(map[string]any)["name"] != "usage" || commands[5].(map[string]any)["name"] != "release-notes" || commands[6].(map[string]any)["name"] != "flush" || commands[7].(map[string]any)["name"] != "dream" || commands[8].(map[string]any)["name"] != "memory" || commands[9].(map[string]any)["name"] != "context" || commands[10].(map[string]any)["name"] != "session-info" || commands[11].(map[string]any)["name"] != "goal" || commands[12].(map[string]any)["name"] != "loop" || commands[13].(map[string]any)["name"] != "workflows" || commands[14].(map[string]any)["name"] != "workflow" || commands[15].(map[string]any)["name"] != "deep-research" {
	...
	commands = commandResponse["result"].(map[string]any)["commands"].([]any)
	if len(commands) != 14 || commands[2].(map[string]any)["name"] != "privacy" || commands[3].(map[string]any)["name"] != "doctor" || commands[4].(map[string]any)["name"] != "usage" || commands[5].(map[string]any)["name"] != "release-notes" || commands[6].(map[string]any)["name"] != "memory" || commands[7].(map[string]any)["name"] != "context" || commands[8].(map[string]any)["name"] != "session-info" || commands[9].(map[string]any)["name"] != "goal" || commands[10].(map[string]any)["name"] != "loop" || commands[11].(map[string]any)["name"] != "workflows" || commands[12].(map[string]any)["name"] != "workflow" || commands[13].(map[string]any)["name"] != "deep-research" {
