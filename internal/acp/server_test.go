...
func TestMemoryFlushExtensionAndSlashCommand(t *testing.T) {
	...
	if len(commands) != 9 || commands[2].(map[string]any)["name"] != "flush" || commands[3].(map[string]any)["name"] != "dream" || commands[4].(map[string]any)["name"] != "memory" || commands[5].(map[string]any)["name"] != "context" || commands[6].(map[string]any)["name"] != "session-info" || commands[7].(map[string]any)["name"] != "goal" || commands[8].(map[string]any)["name"] != "loop" {
	...
	commands = commandResponse["result"].(map[string]any)["commands"].([]any)
	if len(commands) != 7 || commands[2].(map[string]any)["name"] != "memory" || commands[3].(map[string]any)["name"] != "context" || commands[4].(map[string]any)["name"] != "session-info" || commands[5].(map[string]any)["name"] != "goal" || commands[6].(map[string]any)["name"] != "loop" {
