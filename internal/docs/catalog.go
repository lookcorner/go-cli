...
var guides = []Guide{
	...
	guide("Sandbox Mode", "Filesystem and network confinement", "Workspace tools enforce root confinement, symlink checks, permission rules, and explicit mutation approval. OS-level Landlock, Seatbelt, and seccomp isolation are not yet implemented in this Go build."),
