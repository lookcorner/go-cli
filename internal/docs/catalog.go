...
var guides = []Guide{
	...
	guide("Terminal Support and Troubleshooting", "tmux, SSH, color, clipboard, and mouse diagnostics", "Run `gork doctor` or `/doctor` (`/terminal-setup`) to inspect color, clipboard, tmux, SSH, and mouse-reporting behavior. The TUI supports OSC 52 clipboard transfer and tmux-aware OSC 8 links."),
