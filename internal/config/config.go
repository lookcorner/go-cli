...
type Config struct {
	...
	uiContextualImageConfigured     bool
...
type DisplayRefreshConfig struct {
	ProbeEnabled       bool   `json:"probe_enabled" toml:"probe_enabled"`
	AutoCadenceEnabled bool   `json:"auto_cadence_enabled" toml:"auto_cadence_enabled"`
	FloorMS            uint32 `json:"floor_ms" toml:"floor_ms"`
	CeilingMS          uint32 `json:"ceiling_ms" toml:"ceiling_ms"`
	MinHz              uint32 `json:"min_hz" toml:"min_hz"`
	MaxHz              uint32 `json:"max_hz" toml:"max_hz"`
}

type refreshConfigured struct {
	probe, auto, floor, ceiling, minHz, maxHz bool
}
...
type MCPServerConfig struct {
	...
	ToolTimeoutSeconds      *uint64           `json:"tool_timeout_sec,omitempty" toml:"tool_timeout_sec"`
...
type RefreshSettings struct {
	ProbeEnabled       *bool   `json:"probe_enabled,omitempty" toml:"probe_enabled"`
	AutoCadenceEnabled *bool   `json:"auto_cadence_enabled,omitempty" toml:"auto_cadence_enabled"`
	FloorMS            *uint32 `json:"floor_ms,omitempty" toml:"floor_ms"`
	CeilingMS          *uint32 `json:"ceiling_ms,omitempty" toml:"ceiling_ms"`
	MinHz              *uint32 `json:"min_hz,omitempty" toml:"min_hz"`
	MaxHz              *uint32 `json:"max_hz,omitempty" toml:"max_hz"`
}

type hints struct {
	Undo        *bool `json:"undo,omitempty" toml:"undo"`
	PlanMode    *bool `json:"plan_mode,omitempty" toml:"plan_mode"`
	ImageInput  *bool `json:"image_input,omitempty" toml:"image_input"`
...
func applyFileConfig(cfg *Config, disk *fileConfig) error {
	...
	if disk.UI.ContextualHints != nil && disk.UI.ContextualHints.PlanMode != nil {
		cfg.UI.ContextualHints.PlanMode = *disk.UI.ContextualHints.PlanMode
		cfg.uiContextualPlanModeConfigured = true
	}
	if disk.UI.ContextualHints != nil && disk.UI.ContextualHints.ImageInput != nil {
		cfg.UI.ContextualHints.ImageInput = *disk.UI.ContextualHints.ImageInput
		cfg.uiContextualImageConfigured = true
	}
	if disk.UI.ContextualHints != nil && disk.UI.ContextualHints.SendNow != nil {
		cfg.UI.ContextualHints.SendNow = *disk.UI.ContextualHints.SendNow
		cfg.uiContextualSendNowConfigured = true
	}
...
func applyEnv(cfg *Config) {
	...
	if value, ok := envBool("GROK_DISPLAY_REFRESH_AUTO_CADENCE"); ok {
		cfg.UI.DisplayRefresh.AutoCadenceEnabled = value
...
func applyContextualHintsEnvironment(cfg *Config) {
	if cfg.uiContextualHintsEnvironment == nil {
		return
	}
...
func applyRequirementsData(cfg *Config, data []byte, source string, envFailClosed, envDisablesAPIKey bool) error {
	...
	if requirement.UI.ContextualHints != nil && requirement.UI.ContextualHints.PlanMode != nil {
		cfg.UI.ContextualHints.PlanMode = *requirement.UI.ContextualHints.PlanMode
		cfg.uiContextualPlanModeConfigured = true
	}
	if requirement.UI.ContextualHints != nil && requirement.UI.ContextualHints.ImageInput != nil {
		cfg.UI.ContextualHints.ImageInput = *requirement.UI.ContextualHints.ImageInput
		cfg.uiContextualImageConfigured = true
	}
	if requirement.UI.ContextualHints != nil && requirement.UI.ContextualHints.SendNow != nil {
		cfg.UI.ContextualHints.SendNow = *requirement.UI.ContextualHints.SendNow
		cfg.uiContextualSendNowConfigured = true
	}
